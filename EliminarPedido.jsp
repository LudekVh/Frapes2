...
<body>
    ...
    try{
        ...
        int x= stmt.executeUpdate("DELETE FROM pedido WHERE id='"+id+"'");
         if(x>0){
               out.println("<h1> Pedido Borrado</h1>");
             }
        }//fin del if
        }//fin del try
    ...
    <a href="InsertarPedido.html"><input type='submit' class='btn btn-outline-success'  name='insertar cliente'value='Insertar Pedido'>

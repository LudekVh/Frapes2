...
<body>
    ...
    try{
        ...
        int x= stmt.executeUpdate("DELETE FROM cliente WHERE id='"+id+"'");
         if(x>0){
               out.println("<h1> Registro Borrado</h1>");
             }
        }//fin del if
        }//fin del try
    ...
    <a href="Insertar.html"><input type='submit' class='btn btn-outline-success'  name='insertar cliente'value='Insertar Cliente'>

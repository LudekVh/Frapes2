...
<%
      ...
      try{
         ...
         if(con != null){
            ...
            ResultSet res=st.executeQuery("SELECT * FROM pedido WHERE id = '"+id+"'");
            ...
            while(res.next()){
               ...
               out.println("<form action=\"ActualizarPed.jsp\" class='formulario' id='formulario' name='formulario'>");
               ...
               out.println("<input type=\"submit\" class='btn' name='actualizar pedido' value='Actualizar Pedido'>");
               out.println("</div>");
               out.println("</div>");
               out.println("</center>");
            }

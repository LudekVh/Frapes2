...
int id=Integer.parseInt(request.getParameter("id"));
      try{
         ...
         if(con != null){
            ...
            ResultSet res=st.executeQuery("SELECT * FROM compra WHERE id = '"+id+"'");
            ...
            while(res.next()){
               ...
               out.println("<form action=\"ActualizarCom.jsp\" class='formulario' id='formulario' name='formulario'>");
               out.println("<center>Actualizar Compra</center>");
               out.println("<div class='contendor'>");
              out.println("<input type=\"hidden\" name=\"id\" value='"+id+"'>");
               ...
               out.println("<input type=\"submit\" class='btn' name='actualizar compra' value='Actualizar Compra'>");
               out.println("</div>");
               out.println("</div>");
               out.println("</center>");
            }

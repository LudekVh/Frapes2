...
int id=Integer.parseInt(request.getParameter("id"));
      try{
         ...
         if(con != null){
            ...
            ResultSet res=st.executeQuery("SELECT * FROM vendedor WHERE id = '"+id+"'");
            ...
            while(res.next()){
               ...
               out.println("<form action=\"ActualizarVen.jsp\" class='formulario' id='formulario' name='formulario'>");
               out.println("<center>Actualizar Vendedor</center>");
               out.println("<div class='contendor'>");
               ...
               out.println("<input type=\"submit\" class='btn' name='actualizar' value='Actualizar Vendedor'>");
               out.println("</div>");
               out.println("</div>");
               out.println("</center>");
            }

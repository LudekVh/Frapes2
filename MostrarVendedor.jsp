     ...
     <table>
        ...
        <%while(res.next()){
         ...
         <tr>
            ...
            <td><%=direcion%></td>
            <td><%=telefono%></td>
            <td><a href="ActualizarVendedor.html?id="+id+><input type='submit' class='btn btn-outline-success'  name='actualizar'value='Actualizar Vendedor'></a></td>
            <td><a href="EliminarVendedor.html?id="+id+><input type='submit' class='btn btn-outline-danger'  name='borrar'value='Borrar Vendedor'></a></td>
         </tr>
         </center>
         <%}%>
     </table>
     <td><a href="InsertarVendedor.html"><input type='submit' class='btn btn-outline-primary'  name='insertar cliente'value='Insertar Vendedor'></a></td>
     <% }//fin del if
        }//fin del try
